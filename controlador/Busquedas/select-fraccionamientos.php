...
echo '<select id="fraccionamiento_slc" class="form-control" name="fraccionamiento_slc" onchange="cargarLoteManzana()" >';
echo '<option value=null>--Fraccionamientos--</option>';
