                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 table">
                         ...
                         <div id="divMateria"class="form-horizontal form-label-left">     <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="respuesta">Materia
                         </label>
                          <div  id="idRespuestaCambio" class="col-md-6 col-sm-6 col-xs-12">
                          <select id='agrarioIntancia' onchange="iniciarPregunta(this)" respuesta='valor' required=' ' class='form-control '>
                                             <option value="NIGUNO" >- Seleccione -</option> 
                                            <option value="5">CIVIL</option> 
                                            <option value="7">AGRARIO</option>   
                                            <option value="1">PENAL</option>   
                                            <option value="3">FAMILIAR</option>   
                                            <option value="9">EJECUCIÓN DE SANCIONES</option>   
