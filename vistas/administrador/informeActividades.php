...
<form id="myform" action="#" class="form-horizontal form-label-left" >
  <div align="center">
    ...
    <div class="form-group ">
    	...
    	<div class="col-md-6 col-sm-6 col-xs-4 form-group has-feedback">
        <input type="date" id="inputFinal" name="inputFinal"  onblur="myFunctionDate(this)" onkeyup="myFunctionDate(this)" data-error="ingresa fecha menor a la final" required min="2018-03-25" max="2018-05-25" step="1">
