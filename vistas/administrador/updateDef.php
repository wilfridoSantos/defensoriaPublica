             ...
             <div class="row" id="menuContainer">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                               
                  ...
                  <form id="myform" data-toggle="validator" role="form" class="example_form form-horizontal form-label-left"
                    action ="../../controlador/defensor/controlActualizarDef.php?" 
                    method="post"  enctype="multipart/form-data" object="defensor">
