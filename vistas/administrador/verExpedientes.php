...
<script src="../../recursos/js/main.js"></script>
      <script src="../../recursos/js/herramientaHtml.js"></script>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i><b>Lista expedientes del Defensor</b></h2>
<!--                     <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
                      ...
                      <div id="dialogoDetalleExp">
                                                            
                      </div>
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Detalle Expediente</a>
                        </li>
                      </ul>
