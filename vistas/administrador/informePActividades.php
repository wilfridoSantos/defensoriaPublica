...
<link rel="stylesheet" href="../../recursos/vendors/jquery/jquery-ui-themes-1.12.1/jquery-ui.css">
 -->
 <script>seleccionarUnDefensorParcial(true)</script>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">         
                    <form id="myform" data-toggle="validator" class="form-horizontal form-label-left" novalidate="">
                        <div class="form-group col-md-12">
                            <label class="radio-inline">
                                <input type="radio" id="inputRadio3" name="optradioP" >Informe parcial con periodo de tiempo
                            </label>
                            <label class="radio-inline">
                                <input type="radio" id="inputRadio4" checked name="optradioP" >Informe parcial completo.
                            </label>
                        </div>
                        ...
                        <div class="form-group col-md-12" id="checkDefensor" name="checkDefensor">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-check-label" >Defensor en especifico? 
                                    <input type="checkbox" checked id="checkId" name="checkDefensor" class="form-check-input" onchange="seleccionarUnDefensorParcial(this.checked)" >                          
                                </label>
                            </div>
                            <div class="form-group col-md-6" id="idCheckDefensor" name="idCheckDefensor" style="display:none;">
                                <div class="form-inline">
                                    <label class="form-inline col-md-4" for="project">Eliga un defensor<span class="required">*</span></label>
                                        <input  class="form-inline col-md-6" data-error="Seleccione un defensor" type="text"  id="project"  required onchange="estadoInputParcial(this.value)">                                                                                              
                    ...
                    <div class="row no-print">
						             <div class="col-xs-12">
						               <button class="btn btn-success pull-right" id="botonDesc" disabled onclick="generarPDFActividadesParcial();" style="margin-right: 5px;">
