...
<html lang="en">
  <head>
    ...
    <title>Modúlo GENERADOR DE ESTADSTICA</title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a><i class="fa fa-home"></i> Expediente<span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-home"></i> Generar informes generales<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-home"></i> Generar informes parciales <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a id="informePExpedientes">Generar informe parcial de expedientes</a></li>       
                      <li><a id="informePActividades">Generar informe parcial de actividades</a></li>                      
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../../recursos/images/<?php echo $_SESSION['foto']?>" alt=""/><?php// echo $_SESSION['usuario'] ?>
