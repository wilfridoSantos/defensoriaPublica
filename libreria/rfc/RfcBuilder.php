...
//include_once('juristicPerson.php');
include_once('NaturalPerson.php');
include_once('VerificationDigitCalculator.php');
include_once('NaturalPersonTenDigitsCalculator.php');
//include_once('JuristicPersonTenDigitCalculator.php');
include_once('HomoclaveCalculator.php');
