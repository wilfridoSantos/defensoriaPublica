          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="images/defensoria v1.jpg" alt="..." class="img-circle profile_img"/>
              </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i>Usuario del servicio<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Ver mis usuarios</a></li>
                      <li><a href="form_advanced.html">Alta</a></li>
                      <li><a href="form_validation.html">Finalizar Expediente</a></li>
                      <li><a href="form_wizards.html">Actualizar</a></li>
                    </ul>
                  </li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      lista de sus benificiarios activos
                    </p>
