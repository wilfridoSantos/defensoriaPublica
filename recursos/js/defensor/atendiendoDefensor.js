		      ...
		      if (VALOR.num_expediente!=""&VALOR.estado!="finalizado") {
				...
				var observacion=((VALOR.observaciones!=null)?VALOR.observaciones:" ");
				 ...
				 $('#tebody').append(
					...
					'<td > <textarea id="num_expediente"   rows="1%"  disabled cols="10" minlength="10" maxlength="250"   style="background-color:transparent;overflow: auto; color:#000000; border:none; resize: none;" readonly class="form-control col-md-3 col-xs-12"> '+VALOR.num_expediente.toUpperCase()	+'</textarea></td>'+
					'<td > <textarea    rows="1%"  disabled cols="30" minlength="10" maxlength="250"   style="background-color:transparent;overflow: auto; color:#000000; border:none; resize: none;" readonly class="form-control col-md-3 col-xs-12"> '+VALOR.nombre_delito.toUpperCase()+'</textarea></td>'+
					'<td> <textarea 	rows="1%"  disabled cols="35" minlength="10" maxlength="250" style="background-color:transparent; border:none; auto; color:#000000;resize: none;" readonly class="form-control col-md-5 col-xs-12" >'+VALOR.tipo_delito.toUpperCase()+'</textarea></td>'+
