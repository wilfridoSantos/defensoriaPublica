function informeAmbasByDefPeriodo(sistema, atributos){
    ...
    var pdfAct  = {
		...
		content: [
			...
			{ text: 'Con el objetivo de contribuir a una justicia pronta, expedita e imparcial, se obtuvieron xxxx registros de expedientes del defensor.', style: 'textoJustificado' },
