...
function getTablaGeneralExp2(valor){
	switch(valor){
		case 'TRADICIONAL':
...
function getTablaActividades2(valor){
	switch(valor){
		case 'TRADICIONAL':
			return{
				style : 'tableExample',
...
function getTablaSexoExp2(valor){
	//sexos = getNumSexoUsuarios(jsonInf);
	var tabla ={};
	var tablaGeneral={};
	tablaGeneral.headerRows= 2;
...
function getTablaGeneroExp2(valor){
	//generos = getNumGeneroUsuarios(jsonInf);
	var tabla ={};
	var tablaGeneral={};
	tablaGeneral.headerRows= 2;
...
function getTablaEdadExp2(valor){
	//edades = getNumEdadUsuarios(jsonInf);
	var tabla ={};
	var tablaGeneral={};		
	tablaGeneral.headerRows= 3;
...
function getTablaEtniasExp2(valor){	
	var tabla ={};
	var tablaGeneral={};
	tablaGeneral.headerRows= 3;		
	//console.log(generarCuerpoEtnias(), 'cuerpo funcioin generar cuerpo etnias');
...
function getTablaIdiomasExp2(valor){
    var tabla ={};
	var tablaGeneral={};
	tablaGeneral.headerRows= 3;		
	//console.log(generarCuerpoEtnias(), 'cuerpo funcioin generar cuerpo etnias');
...
function getTablaDiscapacidadExp2(valor){
	var tabla ={};
	var tablaGeneral={};
	tablaGeneral.headerRows= 3;
	switch(valor){
		case 'TRADICIONAL':
			return{
					...
					table:{
						widths: ['auto', 'auto', 'auto', 'auto','auto'],
						headerRows: 3,					
						body: generarCuerpoDiscapacidadP2()
					}				
			}
		break;
		case 'ORAL':
...
function getTablaMateria2(valor){
	var tabla ={};
	var tablaGeneral={};		
	tablaGeneral.headerRows= 1;
...
function getTablaRegionExp2(valor){
	var tabla ={};
	var tablaGeneral={};		
	tablaGeneral.headerRows= 3;
...
function generarCuerpoRegionP2(){
	var totalFinal = 0;
...
function generarCuerpoDiscapacidadP2(){
	var totalFinal = 0;
...
function generarCuerpoIdiomasT2(){
	var totalFinal = 0;
	var sourceData = jsonInf['tablaIdiomaExp'];
	var listaIdiomas = getNumIdiomasUsuarios(sourceData);
	var bodyData = [];	
...
function generarCuerpoEtniasT(){
	...
	//console.log(sourceData, ' etnias def');
	...
	var bodyData = [];	
			...
			var totalFinal=0, totTra=0, totOr=0, totHT=0,totMT=0, totHO=0, totMO=0;
			//console.log(listaEtnias.length,' longitud de lista maestra');
...
function generarCuerpoEtniasT2(){
	var totalFinal = 0;
