function informeNingunoPeriodo(sistema, atributos){
    console.log(sistema, atributos, ' entro a funcion pdf xDDDDDD');
    console.time('Test informePERIODO ninguno');
	var tablaSexo={}, tablaGenero={},tablaGeneral={}, tablaEdad={}, tablaEtnia={}, tablaIdioma={}, tablaDiscapacidad={};
	var tablaActividades={}, tablaRegion={}, tablaTop={};
    var campo={};
    ...
    for(var i=0; i<atributos.length; i++ ){
        switch(atributos[i]){
            ...
            case 'REGION':
            campo={ text:'A continuación se desglosan los atributos de los beneficiarios involucrados en los expedientess.', style: 'textoJustificado' };
                tablaRegion = getTablaRegionExp2(sistema);
            break;
            case 'MATERIA':
            campo={ text:'A continuación se desglosan los atributos de los beneficiarios involucrados en los expedientess.', style: 'textoJustificado' };
	...
	console.timeEnd('Test informePERIODO ninguno');
	return pdfAct;
}